...
def test():
    ...
    print(Interval(Pitch('E3'), Pitch('F4')))
    ...
    print(Interval(Pitch('C00'), Pitch('G9')))
    print(Interval(Pitch('C00'), Pitch('F##9'))  )
