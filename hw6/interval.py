...
def test():
    ...
    print("TEST: ", Interval(Pitch('E3'), Pitch('F4')))
    print("TEST: ", Interval(Pitch('D##4'), Pitch('Ebb3')))
    print("TEST: ", Interval(Pitch('E9'), Pitch('C00'))  )
    print("TEST: ", Interval(Pitch('C##4'), Pitch('Cbb4')))
    print("TEST: ", Interval(Pitch('Bbb4'), Pitch('F##4')))
    print("TEST: ", Interval(Pitch('B##4'), Pitch('Fbb4')))
    print("TEST: ", Interval(Pitch('Cs4'), Pitch('B3')))
    print("TEST: ", Interval(Pitch('E4'), Pitch('D4')) )
    print("TEST: ", Interval(Pitch('E4'), Pitch('D#4')))
    print("TEST: ", Interval(Pitch('Cs4'), Pitch('B3')))
    print("TEST: ", Interval(Pitch('Cs4'), Pitch('B2')))
    print("TEST: ", Interval(Pitch('Cs4'), Pitch('B5')))
    print("TEST: ", Interval(Pitch('Bb5'), Pitch('Cs4')))
    print("TEST: ", Interval(Pitch('B3'), Pitch('Bb3')) )
    print("TEST: ", Interval(Pitch('Eb4'), Pitch('D#4')) )
    print("TEST: ", Interval(Pitch('B3'), Pitch('Bb3')) )
    print("TEST: ", Interval(Pitch('Eb4'), Pitch('D#4')) )
    print("TEST: ", Interval(Pitch('Cbb4'), Pitch('C##6')) )
    print("TEST: ", Interval(Pitch('C#5'), Pitch('C4')) )
    print("TEST: ", Interval(Pitch('C##5'), Pitch('C4'))  )
    print("TEST: ", Interval(Pitch('C##5'), Pitch('Cb4'))  )
    print("TEST: ", Interval(Pitch('C##5'), Pitch('Cbb4'))  )
    print("TEST: ", Interval(Pitch('C##5'), Pitch('Cbb3'))  )
    print("TEST: ", Interval(Pitch('F4'), Pitch('B4')) )
    print("TEST: ", Interval(Pitch('F4'), Pitch('B#4')))
    print("TEST: ", Interval(Pitch('F4'), Pitch('B##4'))  )
    print("TEST: ", Interval(Pitch('Fb4'), Pitch('B##4')) )
    print("TEST: ", Interval(Pitch('Fbb4'), Pitch('B##4')))
    print("TEST: ", Interval(Pitch('B#4'), Pitch('Fbb4')))
    print("TEST: ", Interval(Pitch('Fbb5'), Pitch('B##4')))
    print("TEST: ", Interval(Pitch('C00'), Pitch('G9')))
    print("TEST: ", Interval(Pitch('C00'), Pitch('F##9'))  )
    print("TEST: ", Interval(Pitch('C00'), Pitch('Abb9')))
